...
class Client(
    ...
    companion object {
        fun getMock() = listOf(
            ...
            Client(2, "Маша", "Черничкина", "+79219781373", Gender.FEMALE.code, "iiaquamarieii", "d29026@yandex.ru",
                "26.05.1993", null, R.drawable.masha),
            Client(3, "Евгений", "Стирманов", "+79210000000", Gender.MALE.code, "uginstarr", "d29027@yandex.ru",
