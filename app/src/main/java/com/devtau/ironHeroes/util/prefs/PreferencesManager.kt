...
object PreferencesManager {
    ...
    fun observeShowChampionFilter() = LiveDataPreferenceBoolean(prefs, SHOW_CHAMPION_FILTER, true)
    fun observeShowHeroFilter() = LiveDataPreferenceBoolean(prefs, SHOW_HERO_FILTER, true)
    fun observeOpenEditDialogFromStatistics() = LiveDataPreferenceBoolean(prefs, OPEN_EDIT_DIALOG_FROM_STATISTICS, true)
